...
/**
 * 角色-权限关联实体（system.sys_role_permission）：RBAC0 角色轴与权限轴的绑定关系。
 *
 * <p>P0 只有 INSERT/DELETE（绑定与解绑），无 UPDATE 生命周期故 DDL 不挂 updated_at 触发器；
 * (role_id, permission_id) 联合唯一（deleted=0 范围内）。
 */
@Getter
@Setter
@TableName("system.sys_role_permission")
