 ...
 *
 * <p>推送目标为内存 SimpleBroker（/topic 前缀）——进程内分发至已订阅 WebSocket 会话，非 MQ 代理
 * 发送，不涉"事务内禁 MQ 发送"约束（宪法 A.4.2-7 针对代理型 MQ）；多实例经 MQ 扇出推送网关的
 * 完整化 P1（14-iot FU-M14-07）。两个主题（简报 §1.4/§1.5）：
 *
 * <ul>
