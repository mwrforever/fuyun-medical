...
class MessagingGovernanceIT {
    ...
    @Test
    @Order(1)
    @DisplayName("冻结登记断言：event_registry 七十三条种子行齐全且全部 ACTIVE，system.dict.published 生产方为 system")
    void seedRegistryRowsAreFrozenAndActive() {
        ...
        assertThat(totalRows).isEqualTo(73);
        ...
        assertThat(activeRows).isEqualTo(73);
